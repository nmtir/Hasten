...
const TaskHeader = ({ taskViewHandler, openCreateBoard }) => {
  return (
    <div className="flex items-center flex-wrap gap-4">
      ...
      <div className="flex-none flex items-center gap-4">
        <div className="relative">
          <span
            className="absolute top-1/2 -translate-y-1/2 right-2.5 text-default-600 w-8 h-full border-l border-default-200 flex justify-center items-center">
