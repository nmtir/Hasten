...
const SidebarImage = () => {
  ...
  const hslPrimary = `hsla(${
    newTheme?.cssVars["light"].primary
  })`;
  ...
  return (
    ...
    >
      <div
        className="mb-2 relative inline-block px-3 py-[3px] rounded before:bg-[--theme-primary] before:absolute before:top-0 before:left-0 before:w-full  before:h-full before:rounded before:opacity-10 before:z-[-1]  text-[--theme-primary]  text-xs font-medium">
        Sidebar Image
      </div>
      ...
      <div className=" grid grid-cols-7 gap-3">
        ...
        <label
          className=" h-[72px] rounded border border-border bg-border  flex items-center justify-center text-muted-foreground">
