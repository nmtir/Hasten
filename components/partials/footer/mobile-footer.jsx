...
import { Settings, SiteLogo, DSearch } from 'components/svg';
import Link from 'next/link';

const MobileFooter = ({ handleOpenSearch }) => {
  return (
    <footer className="bg-card bg-no-repeat mt-4  shadow-[0_-4px_29px_#9595952b] dark:shadow-[0_-4px_29px_#000000cc] footer-bg  border-t dark:border-none flex justify-around items-center backdrop-filter backdrop-blur-[40px] fixed left-0 w-full z-50 bottom-0 py-[12px] px-4">
