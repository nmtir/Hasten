    ...
    if (category) {
      startTransition(async () => {
        try {
          ...
          toast.success('Successfully updated ', response.title);
      ...
      startTransition(async () => {
        try {
          const response = await createCategory(data, user.id, location);
          toast.success('Successfully added ', response.title);
        } catch (error) {
          toast.error('Something Went Wrong');
          console.log(error);
        }
