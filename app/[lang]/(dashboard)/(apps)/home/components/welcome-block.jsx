...
import calendar from 'public/images/all-img/calendar.png';
...
const WelcomeBlock = ({ user }) => {
  ...
  return (
    <div className="w-full h-full bg-primary rounded-md  flex p-6 relative ">
      ...
      <div className="absolute bottom-0 ltr:right-4 rtl:left-4 ltr:md:right-[30%] rtl:md:left-[30%] ltr:md:bottom-5 ltr:2xl:right-10 rtl:2xl:left-10 w-[200px] ">
        <Image
          src={calendar}
          alt="user"
