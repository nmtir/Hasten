  ...
  return (
    <>
      <Avatar className="h-[64px] w-[64px]">
        <AvatarImage src={avatar1} alt="" />
        <AvatarFallback>SN</AvatarFallback>
      </Avatar>
      <Avatar className="h-[56px] w-[56px]">
        <AvatarImage src={avatar2} alt="" />
        <AvatarFallback>AB</AvatarFallback>
      </Avatar>
      <Avatar className="h-12 w-12">
        <AvatarImage src={avatar3} alt="" />
        <AvatarFallback>CD</AvatarFallback>
      </Avatar>
      <Avatar className="h-11 w-11">
        <AvatarImage src={avatar4} alt="" />
        <AvatarFallback>EF</AvatarFallback>
      </Avatar>
      <Avatar className="h-10 w-10">
        <AvatarImage src={avatar5} alt="" />
        <AvatarFallback>GH</AvatarFallback>
      </Avatar>
      <Avatar className="h-9 w-9">
        <AvatarImage src={avatar6} alt="" />
        <AvatarFallback>IJ</AvatarFallback>
      </Avatar>
      <Avatar className="h-8 w-8">
        <AvatarImage src={avatar7} alt="" />
        <AvatarFallback>KL</AvatarFallback>
      </Avatar>
      <Avatar className="h-[30px] w-[30px]">
        <AvatarImage src={avatar8} alt="" />
