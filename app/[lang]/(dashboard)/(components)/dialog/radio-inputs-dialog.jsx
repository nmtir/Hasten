          ...
          <ul className="space-y-4 w-full">
              ...
              <Label htmlFor="job_1" className="w-full">
                <div className="flex items-center">
                  <div className="grow flex flex-col gap-1">
                    <h3 className="text-sm font-semibold text-default-950 group-hover:text-primary">UX/UI Design
                      Course</h3>
                    <span className="text-xs text-default-600">Hasten</span>
            ...
            <li className="border-2 border-default-200 rounded-sm p-3 group hover:border-primary">
              ...
              <Label htmlFor="job_2" className="w-full">
                <div className="flex items-center">
                  <div className="grow flex flex-col gap-1">
                    <h3 className="text-sm font-semibold text-default-950 group-hover:text-primary">PHP/Laravel
                      Course</h3>
                    <span className="text-xs text-default-600">Hasten</span>
                    <span className="text-xs text-default-600">20 seats available</span>
                  </div>
            ...
            <li className="border-2 border-default-200 rounded-sm p-3 group hover:border-primary">
              ...
              <Label htmlFor="job-3" className="w-full">
                <div className="flex items-center">
                  <div className="grow flex flex-col gap-1">
                    <h3 className="text-sm font-semibold text-default-950 group-hover:text-primary">Digital Marketing
                      Course</h3>
                    <span className="text-xs text-default-600">Hasten</span>
                    <span className="text-xs text-default-600">20 seats available</span>
                  </div>
