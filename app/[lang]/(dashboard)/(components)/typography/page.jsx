        ...
        <div className="flex flex-wrap justify-between items-center">
          <div className="space-y-4">
            ...
            <div className="space-y-1 text-wrap">
              <p
                className="text-xs sm:text-base text-muted-foreground font-normal sm:font-medium tracking-wide sm:tracking-widest uppercase">
                ABCDEFGHIJKLMNOPQRSTUVWXYZ
              </p>
              <p
                className="text-xs sm:text-base text-muted-foreground font-normal sm:font-medium tracking-wide sm:tracking-widest lowercase">
                ABCDEFGHIJKLMNOPQRSTUVWXYZ
              </p>
              <p
                className="text-xs sm:text-base text-muted-foreground font-normal sm:font-medium tracking-wide sm:tracking-widest ">
                1234567890
              </p>
            </div>
          </div>
