  ...
  return (
    <div className="space-y-5">
      ...
      <Card title="Left Timeline" code={leftTimeline}>
        <p className="text-sm text-default-500  mb-4">
          Use <span className="text-primary">position="left"</span> props on timeline component to display left align
          timeline.
        </p>
      ...
      <Card title="Alternative Timeline" code={alternativeTimeline}>
        <p className="text-sm text-default-500  mb-4">
          Use <span className="text-primary">position="alternative"</span> props on timeline component to display
      ...
      <Card title="Alternative Reverse Timeline" code={alternativeReverseTimeline}>
        <p className="text-sm text-default-500  mb-4">
          Use <span className="text-primary"> position="alternate-reverse"</span> props on timeline component to display
      ...
      <Card title="Color Dot Timeline" code={colorDotTimeline}>
        <p className="text-sm text-default-500  mb-4">
          Adjust dot color in the <span className="text-primary">TimelineDot component</span> by using the <span
          className="text-primary">color</span> prop with options including
      ...
      <Card title="Timeline With Icon" code={timelineWithIcon}>
        <p className="text-sm text-default-500  mb-4">
          Utilize the "ghost" variant <span className="text-primary">"ghost" variant</span> on the TimelineDot component
          to place an icon on the timeline.
        </p>
        <TimelineWithIcon />
      </Card>
